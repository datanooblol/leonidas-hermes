...
- Customer says "แพงไป" → signals: ["ลูกค้าคัดค้านเรื่องราคา"], action: "ยอมรับความกังวลและอธิบายคุณค่าใหม่"
- Agent argues with customer → signals: ["เอเจนต์โต้แย้งกับลูกค้า"], action: "ยอมรับความกังวลของลูกค้าก่อน"
- Customer hesitates → signals: ["ลูกค้าแสดงความไม่แน่ใจ"], action: "ชี้แจงความกังวลที่แท้จริง"
